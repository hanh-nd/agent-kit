...
export function registerCoreTools(server: McpServer): void {
  ...
  server.registerTool(
    'kit_save_handoff',
    {
      title: 'Save Handoff Artifact',
      description: `Save a handoff artifact to .agent-kit/handoffs/. Returns the saved folder path to use in next-step instructions. Do NOT append version numbers (v2, v3, etc.) to the slug.`,
      inputSchema: {
